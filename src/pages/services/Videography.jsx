...
export default function Videography() {
  useSEO({ title: 'Wedding Videography', description: 'A moody, filmic retelling of your most precious celebrations.' });

  return (
    <main className="bg-brand-dark min-h-screen flex flex-col">
      <PageHero heading="Moments in Motion" subheading="Cinematic film-reel identity." description="A moody, filmic retelling of your most precious celebrations." image="/photos/videography/2.jpg" />

...
export default function Drone() {
  useSEO({ title: 'Drone Photography', description: 'Grand, cinematic views that provide breathtaking context to your celebration.' });
  ...
  return (
    <main className="bg-brand-dark min-h-screen flex flex-col">
      ...
      <section className="bg-brand-dark px-6 max-w-4xl mx-auto text-center py-24 flex-grow flex flex-col justify-center border-t border-brand-charcoal">
        ...
        <a id="book-session-drone" href="/contact" className="inline-block border border-brand-gold/30 hover:border-brand-gold hover:bg-brand-gold/10 px-10 py-4 text-brand-gold tracking-widest text-sm uppercase transition-all duration-700 ease-custom mx-auto">Inquire Now</a>
      </section>
    </main>
  );
}
